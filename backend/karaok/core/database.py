...
def get_db():
    # MySQL TIMESTAMP values use the session timezone; API serialization assumes UTC.
    return mysql.connector.connect(**{**DB_CONFIG, "time_zone": "+00:00"})
...
def get_admin_db():
    ...
    connection = mysql.connector.connect(**{**ADMIN_DB_CONFIG, "time_zone": "+00:00"})
